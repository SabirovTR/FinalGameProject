...
def read_level_parameters(parameters_line, level):
    ...
    level.static = bool(parameters_list[4])
...
def read_obj_parameters(parameters_line, obj):
    ...
    obj.m = float(parameters_list[2])
    obj.x = float(parameters_list[3])
    obj.y = float(parameters_list[4])
    obj.vx = float(parameters_list[5])
    obj.vy = float(parameters_list[6])
    obj.ax = float(parameters_list[7])
    obj.ay = float(parameters_list[8])
    obj.static = bool(parameters_list[9])
    obj.firm = bool(parameters_list[10])
